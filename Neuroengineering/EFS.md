...
- Neurons were stimulated in imaging buffer containing a drug cocktail to inhibit synaptic receptors (10 mM CNQX, 10 mM(R)-CPP, 10 mM gabazine, 1mM (S)-MCPG, Tocris Bioscience). Under these conditions, intracellular cal- cium increases are presumably caused by the opening of voltage sensitive calcium channels.
